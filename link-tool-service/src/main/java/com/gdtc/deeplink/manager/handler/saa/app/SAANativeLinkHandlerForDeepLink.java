...
@Service
public class SAANativeLinkHandlerForDeepLink extends SAANativePlatformSelector implements SAALinkHandlerForDeepLink {
    public static final Logger logger = LoggerFactory.getLogger(SAANativeLinkHandlerForDeepLink.class);
