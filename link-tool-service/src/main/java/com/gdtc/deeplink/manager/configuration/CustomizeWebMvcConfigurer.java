...
public class CustomizeWebMvcConfigurer implements WebMvcConfigurer {
    ...
    private final Logger logger = LoggerFactory.getLogger(CustomizeWebMvcConfigurer.class);
...
//     * 默认情况下依赖中包含Jackson，FastJson并不会生效。
//     */
//    @Override
//    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
//        // TODO 如果要使用fastjson需要将Jackson从依赖中剔除。
